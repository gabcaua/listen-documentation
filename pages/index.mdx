...
We don't recommend you to change that.
</Callout>
...
<Cards>
  ...
  <Card icon="" title="Playing a song" href="/playing-a-song" />
  <Card icon="" title="Select a language" href="/configuration/language" />
</Cards>
<Cards>
  <Card icon="" title="Learn all music commands" href="/commands/music" />
  <Card icon="" title="Learn all social commands" href="/commands/social" />
  <Card icon="" title="Diagnosing problems" href="/playback-problems" />
</Cards>
